using AutoMapper;
using BOnlineStore.Services.Order.Api;
using BOnlineStore.Services.Order.Api.Injections;
...
if (builder.Configuration[AppSettingsKeysConstants.OrderRunningMode] == "docker")
{
...
builder.Services.AddAuthentication(JwtBearerDefaults.AuthenticationScheme)
    .AddJwtBearer(options =>
    {
        ...
        options.Audience = IdentityServerConstants.ApiResourcesOrder;
