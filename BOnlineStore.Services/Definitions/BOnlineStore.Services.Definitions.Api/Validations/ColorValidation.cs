...
namespace BOnlineStore.Services.Definitions.Api.Validations
{
    public class ColorValidator : AbstractValidator<Color>
    {
        ...
        public ColorValidator(IStringLocalizer<Language> stringLocalizer, IColorRepository repository)
        {
            ...
            {
                RuleFor(x => x).Must(CodeUniqueControl).WithMessage(_stringLocalizer[DefinitionApiKeys.ColorCodeMustBeUnique]);
            });

        }

        private bool CodeUniqueControl(Color entity)
        {
