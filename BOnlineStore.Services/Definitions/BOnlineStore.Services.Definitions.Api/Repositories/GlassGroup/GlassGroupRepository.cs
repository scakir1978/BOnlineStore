...
namespace BOnlineStore.Services.Definitions.Api.Repositories
{
    ...
    {
        public GlassGroupRepository(IContext context, IHttpContextAccessor httpContextAccessor, IValidator<GlassGroup> validator, IStringLocalizer<Language> stringLocalizer)
