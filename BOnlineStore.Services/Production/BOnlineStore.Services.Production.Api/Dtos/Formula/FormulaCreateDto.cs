...
{
    /// <summary>
    /// Formül eklemek için kullanılan dto
    /// </summary>
    public class FormulaCreateDto : EntityDto
    {
        /// <summary>
        ///Formül kodu
        /// </summary>
        ...
        public FormulaCreateDto(string code, string name, string? modelId = null, string? rawMaterialId = null,
