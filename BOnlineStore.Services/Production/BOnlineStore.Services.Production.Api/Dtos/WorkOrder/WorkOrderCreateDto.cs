...
namespace BOnlineStore.Services.Production.Api.Dtos
{
    ...
    /// Üretim emri
    /// </summary>
    public class WorkOrderCreateDto : EntityDto
    {
        /// <summary>
        /// İş emri numarası
        /// </summary>
        ...
        public WorkOrderCreateDto(string? workOrderNo = null, string? description = null, string? modelId = null, decimal? amount = null,
            ...
            string? qualityControlInspector = null, string? consignee = null)
        {
